...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { comentario: @comentario.comentario, comentario_id: @comentario.comentario_id, forum_id: @comentario.forum_id, usuario_id: @comentario.usuario_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { comentario: @comentario.comentario, comentario_id: @comentario.comentario_id, forum_id: @comentario.forum_id, usuario_id: @comentario.usuario_id } }
