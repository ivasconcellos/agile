...
class AlunoRespostasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno_resposta" do
    assert_difference('AlunoResposta.count') do
      post aluno_respostas_url, params: { aluno_resposta: { correta: @aluno_resposta.correta, respostas_perguntas_id: @aluno_resposta.respostas_perguntas_id, usuario_curso_id: @aluno_resposta.usuario_curso_id } }
    end
  ...
  test "should update aluno_resposta" do
    patch aluno_resposta_url(@aluno_resposta), params: { aluno_resposta: { correta: @aluno_resposta.correta, respostas_perguntas_id: @aluno_resposta.respostas_perguntas_id, usuario_curso_id: @aluno_resposta.usuario_curso_id } }
