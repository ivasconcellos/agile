...
ActiveRecord::Schema.define(version: 2018_11_13_162104) do
  ...
  create_table "forums", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["curso_id"], name: "index_forums_on_curso_id"
  end
  ...
  add_foreign_key "comentarios", "forums"
  ...
  add_foreign_key "thredded_user_post_notifications", "usuarios", column: "user_id", on_delete: :cascade
